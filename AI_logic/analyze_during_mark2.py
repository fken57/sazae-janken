...
def judge_correct_detailed(test_raw_hands, test_months, learn_during, learn_hash):
    win_count = 0
    loss_count = 0
...
def main():
    ...
    for d in durings:
        learning_result = learning_rock_paper_scissors(train_hands, d, train_months)
        wr, wh = judge_correct_detailed(test_hands, test_months, d, learning_result)
    ...
    ax1.set_title('Mark2 (Month Context): Absolute Wins and Win Rate vs. Learn During', fontsize=14)
    ...
    output_path = r'c:\Users\kenta\pythonPlayGround\winrate_analysis_mark2.png'
