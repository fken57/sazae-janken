...
def main():
    ...
    print("Q学習のトレーニングを開始します。少々お待ちください...")
    for d in durings:
        print(f"learn_during = {d} で学習中...")
        agent = train_q_learning(train_hands, d, epochs=100)
        wr, wh = test_q_learning(test_hands, d, agent)
    ...
    ax1.set_title('Q-Learning: Absolute Wins and Win Rate vs. Learn During', fontsize=14)
    ...
    output_path = 'q_learning_analysis.png'
